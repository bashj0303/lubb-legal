...
LUBB peut collecter :
- Données de compte : email, mot de passe haché, identifiant utilisateur, langue.
- Données nutrition : repas, macros, calories, hydratation, coûts.
- Données entraînement : programmes, séances, séries, répétitions, charges, ressentis.
...
LUBB ne collecte pas la localisation GPS, les contacts, la photothèque, les informations de paiement, les tokens de notifications push ou les données de réseaux sociaux. La caméra sert seulement au scan de codes-barres en direct. Aucune image n'est stockée.

### 4. Sous-traitants
LUBB utilise :
- Supabase pour l'authentification, la base de données et les fonctions serveur.
...
### 10. Tes droits
Tu peux consulter, modifier ou supprimer tes données depuis l'app. Pour toute demande d'accès, portabilité, opposition ou suppression hors app, contacte : lubb.support@gmail.com.
...
### 2. Data collected
LUBB may collect:
- Account data: email, hashed password, user identifier, language.
- Nutrition data: meals, macros, calories, hydration, costs.
- Training data: programs, sessions, sets, reps, loads, ratings.
...
LUBB does not collect GPS location, contacts, photo library, payment information, push notification tokens, or social network data. The camera is only used for live barcode scanning. No images are stored.
...
### 10. Your rights
You can view, edit, or delete your data from the app. For access, portability, objection, or outside-app deletion requests, contact: lubb.support@gmail.com.
